...
namespace System.IO.Pipelines
{
    ...
    public class StreamPipeReaderOptions
    {
        ...
        /// <param name="minimumReadSize">The threshold of remaining bytes in the buffer before a new buffer is allocated. The default value is 1024.</param>
        /// <param name="leaveOpen"><see langword="true" /> to leave the underlying stream open after the <see cref="System.IO.Pipelines.PipeReader" /> completes; <see langword="false" /> to close it. The default is <see langword="false" />.</param>
        /// <param name="waitForData"><see langword="true" /> if reads should wait for the underlying stream to have data before before allocating memory. The default is <see langword="false" />.</param>
        ...
        /// <summary>Gets the value that indicates if reads should wait for the underlying stream to have data before before allocating memory.</summary>
        /// <value><see langword="true" /> if reads should wait for the underlying stream to have data before before allocating memory; otherwise, <see langword="false" />.</value>
